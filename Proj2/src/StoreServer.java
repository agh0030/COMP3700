...
public class StoreServer {
    static String dbfile = "C:\\Users\\austi\\OneDrive\\Desktop\\SQL Databases\\store2 - Copy.db";
        ...
        try {
            ...
            while (true) {
                ...
                if (msg.code == MessageModel.PUT_PURCHASE) {
                    PurchaseModel pm = gson.fromJson(msg.data, PurchaseModel.class);
                    System.out.println("PUT command with Purchase = " + pm);
                    int res = adapter.savePurchase(pm);
